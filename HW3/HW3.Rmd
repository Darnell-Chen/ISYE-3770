...
***b)*** $1 - P(X \geq 119) = 1 - \sum_{x=119}^{125} \binom{125}{x}0.9^x0.1^{125-x} \approx 0.9717376$

Here, I'm assuming that 'empty seats' means 2 or more seats are empty, rather than all seats being empty or only 1 seat being empty.
